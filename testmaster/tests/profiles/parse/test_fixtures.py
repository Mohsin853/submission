...
# Generated by: scrapy crawl profiles -o company_profiles.json  # noqa: E501
# Request URL: https://www.adapt.io/directory/industry/telecommunications/A-1  # noqa: E501
import os
import unittest
...
class TestMaster(unittest.TestCase):
    def test__profiles__parse(self):
        files = os.listdir(
            os.path.dirname(
